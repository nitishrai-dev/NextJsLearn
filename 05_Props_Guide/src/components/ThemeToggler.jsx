...
// step2: Theme provider component an container
...
// step3: crete Custom hook to use theme context
// an custom hook is a function that uses one or more built-in hooks to provide a specific functionality. It allows you to reuse stateful logic across different components without repeating code.
